...
function communicaForm() {
  ...
  function sendEmail(e) {
      ...
      emailjs.sendForm('gmail', 'template_895eiqf', '#contactForm')
      .then(function(response) {
        console.log(response.text);
        setFormMessage("Message sent!");
      }, function(error) {
        console.log(error.text);
        setFormMessage("Your message couldn't be sent. Please email Alex directly at alexandersegerev@gmail.com");
      });
  }
